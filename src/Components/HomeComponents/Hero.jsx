    ...
    <div className='w-full bg-white'>
        <div className='md:max-w-[1380px] m-auto grid md:grid-cols-2 max-w-[350px]'>
            <div className='flex flex-col justify-center gap-4 '>
                ...
                <form action="" className='bg-white border max-w-[650px] md:p-4 p-2 mb-2  md:mt-5  shadow-lg rounded-lg flex justify-between'>
                    <input className='bg-white w-full outline-none focus:outline-none' type="text" 
