    ...
    const handleLogin = async () => {
        try {
          ...
          if (response.status === 200) {
            ...
            const role = response.data.is_consultancy ? 800 : false;
    ...
    <div className="container h-full md:px-6 py-24  md:w-[1380px] w-[600px] ">
      <div className="g-6 flex h-full w-full flex-wrap items-center justify-center lg:justify-between">
        ...
        <div className=" md:ml-1 ml-16 md:w-8/12 w-full lg:ml-6 lg:w-5/12">
            <h1 className='text-center  md:text-5xl py-4 mb-3 '> Consultancy Login</h1>
          {isLoading ? (
          ...
          <form>
            ...
            <div className="mb-6 flex items-center justify-between">
              <p>Doesn't have an account? <span className='text-red-500' style={{cursor:'pointer'}} onClick={()=>navigate('/consultancy-signup')}>Signup</span> </p>
...
export default ConsultancyLoginPage